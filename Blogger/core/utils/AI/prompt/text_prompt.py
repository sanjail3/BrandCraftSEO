GENERATE_BLOG_FROM_BLOG = {
    "template": """- you are a SEO specialist and you need to write a blog post on the following notes: {topic}
                        ...
                        - todays date is {date},I will give the Brand details or company details in json you should generate blog related to the company or brand take into the consideration of the capany produce content
                        Also keep in mind following instructions and brand details:
